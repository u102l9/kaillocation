package com.kail.locationxposed.xposed.hooks.telephony
...
import com.kail.locationxposed.xposed.utils.hookBefore
import com.kail.locationxposed.xposed.utils.hookMethodBefore
import com.kail.locationxposed.xposed.utils.onceHookDoNothingMethod
...
object TelephonyHook: BaseTelephonyHook() {
    operator fun invoke(classLoader: ClassLoader) {
        if(!initDivineService("TelephonyHook")) {
            KailLog.e(null, "Kail_Xposed", "Failed to init mock service in TelephonyHook")
            return
        }
...
//        }
        ...
        val hookGetPhoneTyp = beforeHook {
            if (FakeLoc.enable && !BinderUtils.isSystemAppsCall()) {
                if (FakeLoc.enableDebugLog) {
                    KailLog.d(null, "Kail_Xposed", "getActivePhoneType: injected!")
                }
        ...
        if(cPhoneInterfaceManager.hookAllMethods("getActivePhoneType", hookGetPhoneTyp).isEmpty()) {
            KailLog.e(null, "Kail_Xposed", "Hook PhoneInterfaceManager.getActivePhoneType failed")
        }
        if(cPhoneInterfaceManager.hookAllMethods("getActivePhoneTypeForSlot", hookGetPhoneTyp).isEmpty()) {
            KailLog.w(null, "Kail_Xposed", "Hook PhoneInterfaceManager.getActivePhoneTypeForSlot failed")
        }

        cPhoneInterfaceManager.declaredMethods.find { it.name == "getAllCellInfo" }?.let {
            val hookGetAllCellInfo = afterHook {
                if (FakeLoc.enableDebugLog) {
                    KailLog.d(null, "Kail_Xposed", "getAllCellInfo: injected! caller = ${BinderUtils.getCallerUid()}")
                }
            ...
            if (XposedBridge.hookMethod(it, hookGetAllCellInfo) == null) {
                KailLog.e(null, "Kail_Xposed", "Hook PhoneInterfaceManager.getAllCellInfo failed")
            }
        }
        ...
        if(XposedBridge.hookAllMethods(cPhoneInterfaceManager, "getCellLocation", afterHook {
                ...
                if (FakeLoc.enableDebugLog) {
                    KailLog.d(null, "Kail_Xposed", "${method.name}: injected!")
                }
            ...
            KailLog.e(null, "Kail_Xposed", "Hook PhoneInterfaceManager.getCellLocation failed")
        }

        beforeHook {
            if (FakeLoc.enable && !BinderUtils.isSystemAppsCall()) {
                if (FakeLoc.enableDebugLog) {
                    KailLog.d(null, "Kail_Xposed", "getDataNetworkType: injected!")
                }
                result = 4
            }
        }.let {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            if (cPhoneInterfaceManager.hookAllMethods("getNeighboringCellInfo", beforeHook {
                ...
                KailLog.e(null, "Kail_Xposed", "Hook PhoneInterfaceManager.getNeighboringCellInfo failed")
            }
        }
        ...
        if (cTelephonyRegistry == null) {
            KailLog.e(null, "Kail_Xposed", "TelephonyRegistry not found")
        } else {
    ...
    fun hookTelephonyRegistry(cTelephonyRegistry: Class<*>) {
        cTelephonyRegistry.declaredMethods.filter { (it.name == "listen" || it.name == "listenWithEventList") && !Modifier.isAbstract(it.modifiers) }
            .map {
                ...
                val (m, idx) = it
                if (idx == -1) {
                    KailLog.e(null, "Kail_Xposed", "IPhoneStateListener not found")
                    return@forEach
                }
                m.hookBefore {
                    if (!FakeLoc.enable || BinderUtils.isSystemAppsCall()) {
                    ...
                    if (!hasHookOnCellLocationChanged) {
                        KailLog.e(null, "Kail_Xposed", "Hook onCellLocationChanged failed")
                    }
        ...
        cTelephonyRegistry.hookMethodBefore("notifyCellInfo", List::class.java) {
            ...
            if (FakeLoc.enableDebugLog) {
                KailLog.d(null, "Kail_Xposed", "notifyCellInfo: injected!")
            }
        ...
        cTelephonyRegistry.hookMethodBefore("notifyCellInfoForSubscriber", Int::class.java, List::class.java) {
            ...
            if (FakeLoc.enableDebugLog) {
                KailLog.d(null, "Kail_Xposed", "notifyCellInfoForSubscriber: injected!")
            }
        ...
        cTelephonyRegistry.hookMethodBefore("notifyCellLocation", Bundle::class.java) {
            ...
            if (FakeLoc.enableDebugLog) {
                KailLog.d(null, "Kail_Xposed", "notifyCellLocation: injected!")
            }
        ...
        cTelephonyRegistry.hookMethodBefore("notifyCellLocationForSubscriber", Int::class.java, Bundle::class.java) {
            ...
            if (FakeLoc.enableDebugLog) {
                KailLog.d(null, "Kail_Xposed", "notifyCellLocationForSubscriber: injected!")
            }
    ...
    fun hookSubOnTransact(classLoader: ClassLoader) {
        ...
        if (cISub == null) {
            KailLog.e(null, "Kail_Xposed", "ISub.Stub not found")
            return
        }
...
//                }
        ...
        if(cISub.hookAllMethods("onTransact", hookOnTransact).isEmpty()) {
            KailLog.e(null, "Kail_Xposed", "Hook ISub.Stub.onTransact failed")
        }
    }
