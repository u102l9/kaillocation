...
import com.kail.locationxposed.xposed.utils.hookAllMethodsAfter
import com.kail.locationxposed.xposed.utils.hookAllMethodsBefore
import com.kail.locationxposed.xposed.utils.toClass
import com.kail.locationxposed.xposed.utils.toClassOrThrow
...
//        XposedHelpers.findAndHookMethod("android.location.Location", classLoader, "setLongitude", Double::class.java, hookSetLongitude)
        ...
        kotlin.runCatching {
           ...
           KailLog.e(null, "Kail_Xposed", "Failed to hook LocationResult: ${it.message}")
        }
